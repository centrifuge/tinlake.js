...
const { Admin, Borrower, Lender, Analytics, Currency, Collateral, Governance, ProxyActions } = actions;
const TinlakeWithActions = (ProxyActions(Borrower(Admin(Lender(Analytics(Currency(Collateral(Governance(Tinlake)))))))));
